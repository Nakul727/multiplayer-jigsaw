...
MSG_OBJECT_LOCKED = 'OBJECT_LOCKED'  # New: Notify clients when an object is locked
MSG_OBJECT_RELEASED = 'OBJECT_RELEASED'  # New: Notify clients when an object is released
MSG_ERROR = 'ERROR'
